...
<html>
  ...
  <!-- Facebook and Twitter integration -->
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight" style="width: 400px;">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li style="font-size:15px; font-weight: bold;"><a href="Orderassign.jsp">Exchange Amount</a></li>
    ...
    <!-- ***** Welcome Area Start ***** -->
        ...
        <div class="header-text">
            <h2 align="center" style=" color:orange; font-family: cursive;font-weight: bold; font-size: 30px;">View Work!</h2><br><br>
  ...
  <%                    
        ...
        <!-- Page Content  -->
                            ...
                            <td style="width:200px;"><button><a href="delivery1.jsp?sno=<%=rs.getString("id")%>" style="color: #a367e7;">Exchanged Amount</a></button>&nbsp;&nbsp;</td>
                            </tr> 
                            <%}%>   </table>   
                                        </ul>
			  	</div>
