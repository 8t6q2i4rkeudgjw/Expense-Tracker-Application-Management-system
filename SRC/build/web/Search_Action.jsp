		...
		<div id="colorlib-main">
			<aside id="colorlib-hero" class="js-fullheight">
				<div class="flexslider js-fullheight">
                                   <h2 style="color:darkcyan;font-size: 25px;letter-spacing: 0.3px; margin-top: 10%;margin-left: 40%; "><strong>Add Expense</strong></h2>
                                   <div style="margin-left:30%;">
                                    ...
                                    <table>
                                        ...
                                        <tr><td><input type="text" name="fid" value="<%=r.getString("user_id")%>"></td></tr>
                                        <tr><td><input type="text" name="fname" value="<%=r.getString("username")%>"></td></tr>
                                        <tr><td><input type="text" name="mobile" value="<%=r.getString("mobile")%>"></td></tr>
                                        <tr><td><input type="text" name="mail" value="<%=r.getString("mail")%>"></td></tr>
                                        <tr><td><input type="text" name="city" value="<%=r.getString("city")%>"></td></tr>
