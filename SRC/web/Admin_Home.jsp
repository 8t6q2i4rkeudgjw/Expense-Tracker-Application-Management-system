			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li style="font-size:15px; font-weight: bold;"><a href="Manage_Category.jsp">Add & View Category</a></li>
                                        ...
                                        <li style="font-size:15px; font-weight: bold;"><a href="View_Gproducts.jsp">View All Expense Details</a></li>
					<li style="font-size:15px; font-weight: bold;"><a href="Order.jsp">New Process</a></li>
                                        <li style="font-size:15px; font-weight: bold;"><a href="Add_regular customer.jsp">Add the Regular Customer</a></li>
		...
		<div id="colorlib-main">
			<aside id="colorlib-hero" class="js-fullheight">
				<div class="flexslider js-fullheight">
					<ul class="slides">
				   	<li style="background-image: url('https://blog-assets.freshworks.com/freshdesk/wp-content/uploads/2018/11/XX_tools-.gif'); background-size:1700px;">
				   		<div class="overlay"></div> 
                                                <center>  <h1 style="color:red"> <b></b></h1> </center>
				   		<div class="container-fluid">
				   			<div class="row">
					   			<div class="col-md-6 col-md-offset-3 col-md-push-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner">
					   					  <div class="desc" style="margin-bottom:10px;">
						   					<h1 style="font-size:25px;font-weight: bold;font-family:cursive;color:navy;letter-spacing: 2px;"> Expense Tracker Application</h1>
						   				</div>
					   				</div>
					   			</div>
					   		</div>
