	...
	<div id="colorlib-page" >
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight" style="width: 400px;">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li class="colorlib-active" style="font-size:20px; font-weight: bold;"><a href="Delivery_Home.jsp">Home</a></li>
					<li style="font-size:15px; font-weight: bold;"><a href="Orderassign.jsp">New Process</a></li>
		...
		<div id="colorlib-main">
			<aside id="colorlib-hero" class="js-fullheight">
				<div class="flexslider js-fullheight">
					<ul class="slides">
				   	<li style="background-image: url(images/chde12.png); background-size: auto;">
					   			...
					   			<div class="col-md-6 col-md-offset-3 col-md-push-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner">
					   					  <div class="desc" style="margin-bottom:30px;">
						   					<h1 style="font-size:25px;font-weight: bold;font-family:cursive;color:navy;letter-spacing: 2px;"> Expense Tracker Application Management System </h1>
						   				</div>
					   				</div>
					   			</div>
					   		</div>
