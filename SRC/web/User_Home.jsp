		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight" style="width: 400px;">
			...
			<nav id="colorlib-main-menu" role="navigation">
					...
					<li style="font-size:15px; font-weight: bold;"><a href="Search_Products.jsp">Search Expense</a></li>
                                        <li style="font-size:15px; font-weight: bold;"><a href="View_My_Carts.jsp">View My Added Expense  </a></li> 
		...
		<div id="colorlib-main">
			<aside id="colorlib-hero" class="js-fullheight">
				<div class="flexslider js-fullheight">
					<ul class="slides">
				   	<li style="background-image: url('https://cdn.dribbble.com/users/1601883/screenshots/3547735/first_scene_blue_800x600_2_dribbble.gif'); background-size:900px; margin-left: 50px;">
