			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul >
					...
					<li  style="font-size:15px; font-weight: bold;"><a href="View_Friend_Requests.jsp">View & Delete Friend Requests</a></li>
                                        ...
                                        <li  class="colorlib-active" style="font-size:15px; font-weight: bold;"><a href="View_History.jsp">View All History</a></li>
		...
		<div id="colorlib-main">
			<aside id="colorlib-hero" class="js-fullheight">
				<div class="flexslider js-fullheight">
                                   <h2 style="color:darkcyan;font-size: 25px;letter-spacing: 0.3px; margin-top: 10%;margin-left: 40%; "><strong>View All Status</strong></h2>
                                    <table style="margin-top: 20px;;margin-left: 20%; width: 80%;">
                                        ...
                                        <%
                                            ...
                                            PreparedStatement ps=con.prepareStatement("Select * from buy_cart where uname='"+uname+"' ");
                                        ...
                                        <tr>
                                            ...
                                            <%
                                               if(r.getString("status").equalsIgnoreCase("Failed")){
                                            %>
                                                <td style="color: red"><%=r.getString("status")%></td>
                                            <%
                                               }
                                               else{
                                            %>
