			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul >
					...
					<li style="font-size:15px; font-weight: bold;"><a href="Manage_Category.jsp">Add & View Category</a></li>
                                        ...
                                        <li  class="colorlib-active" style="font-size:15px; font-weight: bold;"><a href="View_Products_Reviews.jsp">View All  Rating & Reviews</a></li>
		...
		<div id="colorlib-main">
			<aside id="colorlib-hero" class="js-fullheight">
				<div class="flexslider js-fullheight">
                                    <h2 style="color:darkcyan;font-size: 25px;letter-spacing: 0.3px; margin-top: 10%;margin-left: 40%; "><strong>View All Uploaded </strong></h2>
                                    <table style="margin-top: 20px;;margin-left: 20%; width: 80%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><%=r.getString("likeproduct")%></td>
                                            <td><%=r.getString("dislikeproduct")%></td>
                                        </tr>
                                        <%}%>
                                    </table>
			  	</div>
