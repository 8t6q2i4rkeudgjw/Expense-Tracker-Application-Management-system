			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul >
					...
					<li style="font-size:15px; font-weight: bold;"><a href="Manage_Category.jsp">Add & View Category</a></li>
                                        <li style="font-size:15px; font-weight: bold;"><a href="Add_Products.jsp">Add Expense</a></li>
                                        <li style="font-size:15px; font-weight: bold;"><a href="View_Products_Reviews.jsp">View All Rating & Reviews</a></li>
                                        <li style="font-size:15px; font-weight: bold;"><a href="Sentiment_Similarity.jsp">Sentiment Similarity by Reviews</a></li>
                                        <li  style="font-size:15px; font-weight: bold;"><a href="View_All.jsp">View All Recommended Expense & Rank Result</a></li>
                                        <li style="font-size:15px; font-weight: bold;"><a href="Graph.jsp">Result</a></li>
                                        <li class="colorlib-active" style="font-size:15px; font-weight: bold;"><a href="View_Users.jsp">View All Users</a></li>
		...
		<div id="colorlib-main">
			<aside id="colorlib-hero" class="js-fullheight">
				<div class="flexslider js-fullheight">
                                   <h2 style="color:darkcyan;font-size: 25px;letter-spacing: 0.3px; margin-top: 10%;margin-left: 40%; "><strong>View All USers(Active & Block)</strong></h2>
                                    <table style="margin-top: 20px;;margin-left: 20%; width: 80%;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="color:maroon;"><%=r.getString("status")%></td>
                                            <%
                                            if(r.getString("status").equalsIgnoreCase("Blocked")){
                                            %>
                                            <td style="color: violet;"><a href="Active.jsp?id=<%=r.getString("user_id")%>" style="color:orangered;">Active</a></td>
                                           <%
                                            }
                                            else{
                                           %>
                                           <td style="color:greenyellow;">Already in Active</td>
                                           <%}%>
                                        </tr>
                                        <%}%>
                                    </table>
